...
import { ArrowRightIcon, ArrowRightLeftIcon, ShieldIcon, UserIcon } from 'lucide-react'
...
<p className="mt-12 text-center md:text-left text-sm text-slate-400">©{new Date().getFullYear()} SUNdigo Solar Solutions Pvt. Ltd. All rights reserved</p>
