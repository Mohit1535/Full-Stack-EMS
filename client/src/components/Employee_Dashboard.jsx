...
w-1 rounded-r-full bg-slate-500/70 
...
text-center inline-flex items-center justify-center gap-2'>Mark Attendance <ArrowRightIcon className='w-4 h-4'/>
</Link>

<Link to="/leave" className='btn-secondary 
text-center '>Apply for Leave <ArrowRightIcon className='w-4 h-4'/>
